...
CREATE TABLE "LearningEvent" (
    ...
    "mcpInsight" TEXT,
    "mcpConfidence" REAL,
    "mcpModel" TEXT NOT NULL DEFAULT 'claude-4-5-sonnet-2026x',
    "dnaChanges" TEXT,
    "beforeState" TEXT,
    "afterState" TEXT,
...
-- CreateIndex
CREATE INDEX "Target_greenLightStatus_idx" ON "Target"("greenLightStatus");

-- CreateIndex
CREATE INDEX "DnaSnapshot_targetId_idx" ON "DnaSnapshot"("targetId");

-- CreateIndex
CREATE INDEX "DnaSnapshot_isActive_idx" ON "DnaSnapshot"("isActive");
...
-- CreateIndex
CREATE INDEX "GreenLightState_status_idx" ON "GreenLightState"("status");
